...
public class ErrorContext {
   ...
   * ### The error may involve com.success.item.mapper.SpuDetailMapper.insert-Inline
   ...
   * ; bad SQL grammar []; nested exception is com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException: Unknown column 'spec_template' in 'field list'
   */
  @Override
